...
export class QuestionService {
  private questionUrl = 'https://api.stackexchange.com/2.2/questions/featured?order=desc&sort=activity&site=stackoverflow';
  private questionsUrl = 'http://localhost:3000/questions/';
  private topQuestionsUrl= 'https://api.stackexchange.com/2.2/questions/featured?order=desc&sort=activity&site=stackoverflow';
